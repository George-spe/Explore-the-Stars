...
const translations = {
    ...
    ko: {
        ...
        gamingContent: {
            title: "성간 체인 게임",
            desc: "자산이 플레이어가 진정으로 소유하고 게ーム 간에 거래할 수 있는 블록체인 기반 게임의 메타버스.",
            points: [
                "NFT 기반 게임 자산",
                "플레이 투 언 메커니즘",
                "게임 간 자산 상호운용성"
    ...
    fr: {
        ...
        gamingContent: {
            ...
            desc: "Un métaverse de jeux basés sur la blockchain où les activos sont véritablement possédés par les joueurs et peuvent être échangés entre les jeux.",
            points: [
                "Activos de jeu basés sur NFT",
                "Mécaniques de jeu pour gagner",
                "Interopérabilité des activos entre les jeux"
            ]
        }
    },
    zh: {
...
function updateLanguage() {
    ...
    // 通知DApp浏览器语言已更改
    notifyDAppBrowserLanguageChange();
}

// 通知DApp浏览器语言已更改
function notifyDAppBrowserLanguageChange() {
...
function initLanguageSwitcher() {
    ...
    if (window.tp && window.tp.getLanguage) {
        window.tp.getLanguage(function(lang) {
