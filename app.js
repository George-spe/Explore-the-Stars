    ...
    connectBtn.addEventListener('click', async () => {
        if (typeof window.ethereum !== 'undefined') {
            try {
                ...
                console.error('User rejected request:', error);
                alert(translations[currentLanguage].connectWalletError || 'Please connect your wallet first!');
            }
        } else {
...
function checkReferral() {
    ...
    if (referrer && currentWalletAddress && referrer.toLowerCase() !== currentWalletAddress.toLowerCase()) {
        ...
        alert(translations[currentLanguage].referralDetected || `You were referred by ${shortRef}`);
    }
}
